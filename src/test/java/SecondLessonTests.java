...
public class SecondLessonTests {
    ...
    public void passwordSelection() {
        final String get_secret_password_homework = "https://playground.learnqa.ru/ajax/api/get_secret_password_homework";
        final String check_auth_cookie = "https://playground.learnqa.ru/ajax/api/check_auth_cookie";
        ...
        for (int i = 0; i < passwords.length; i++) {
            ...
            Response checkAuth = RestAssured
                    ...
                    .andReturn();
            body = checkAuth.body().asString();

            if (body.equals("You are authorized")) break;
        }
        System.out.println(body + " " + data.get("password"));
    }
}
